...
import (
	"fmt"
	"github.com/Benbentwo-Sandbox/test-go-bin-generic-make-mine-6/pkg/github"
...
func (o *VersionOptions) InstallBin(upgrade bool, prefix string, version string) error {
	...
	// BinaryDownloadBaseURL := "https://github.com/Benbentwo-Sandbox/test-go-bin-generic-make-mine-6/releases/download/v1.0.0/
	// 							 https://github.com/Benbentwo-Sandbox/test-go-bin-generic-make-mine-6/releases/download/v1.0.0/go-bin-generic-windows-amd64.zip"
